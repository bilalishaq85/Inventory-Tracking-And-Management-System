...
<?php
$heading1="Customer Inventory Assignment Report";
$dist_code=0;
switch($login_option){
	case 1:
	...
	case 2:
		...
		<div align="right">Link to: 
			...
			<a href="customers.parts.assignment.php">Inventory-Assignment</a>
		</div>		
		<?php
		break;
	case 3:
...
<table width="823" class="listtable2" >
                    <tr class="listheader1" height="22" >
					  ...
					  <td width="178"><div align="center">Part-No</div></td>
                      <td width="311"><div align="center">Part Name</div></td>
                      <td width="92"><div align="center">Min-Quantity</div></td>
                      <td width="92"><div align="center">Max-Quantity</div></td>
					  <td width="103"><div align="center">List-Price</div></td>
                    </tr>
<?php  
$i=-1;
$t_class_code=0;
...
?>
	<tr  bgcolor=<?php echo $list_bgcolor; ?> >
	  <td width="19">
	   ...
	   <td ><div align="right" ><?php echo $row[20]; ?></div><div align="right"></div></td>
	   <td ><div align="right" ><?php echo $row[21]; ?></div></td>
