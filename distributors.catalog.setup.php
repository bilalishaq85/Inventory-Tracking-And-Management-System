...
switch($login_option){
	...
	case 2:
		...
		?>
		<div align="right">Link to: 
			<a href="catalog.view.php">View Catalog</a>
		</div>		
		<?php
		break;
	case 3:
...
<span class="head1">Distributor's Catalog</span>
			<table width="743" class="listtable1" >
                    <tr class="listheader1" height="22" >
                      <td width="227"><div align="center">Part-No</div></td>
                      <td width="313"><div align="center">Part Name</div></td>
                      <td width="134"><div align="center">List-Price</div></td>
                      <td colspan="1"><div align="center">Include</div></td>
                    </tr>
<?php  
$i=-1;
...
?>
  <tr bgcolor=<?php echo $list_bgcolor; ?> >
   ...
   <td width="49" bgcolor=<?php if ($row[7]>0) {echo $p_list_bgcolor_3;} else {echo $list_bgcolor;} ?> ><div align="center">
